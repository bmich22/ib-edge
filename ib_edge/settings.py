...
STATICFILES_FINDERS = [
    ...
    # 'django.contrib.staticfiles.finders.AppDirectoriesFinder',  # Disabled to avoid admin/static
]

STORAGES = {
    "staticfiles": {
    "BACKEND": "whitenoise.storage.CompressedManifestStaticFilesStorage",  # ✅ Use Whitenoise
},
}
